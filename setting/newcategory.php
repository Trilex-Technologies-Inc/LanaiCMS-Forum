...
<input type="hidden" name="ac" value="newcat" />
<tr>
    <td><?=_FORUM_TITLE; ?></td>
    <td><input type="text" name="fctTitle" size="40" />*</td>
</tr>
<tr>
    <td><?=_FORUM_PARENT; ?></td>
    <td>
    ...
    <?
        ...
        while (!$rsg->EOF) {
            ?><option value="<?=$rsg->fields['fctId']; ?>" ><?=$rsg->fields['fctTitle']; ?></option><?
            $rsg->movenext();
        }
    ?>
    </select>
...
<tr>
    ...
    <td><textarea name="fctDescription" rows="5" cols="40"></textarea></td>
</tr>
</FORM>
</table>
