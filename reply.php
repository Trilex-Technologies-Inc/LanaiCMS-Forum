...
<div class="container mt-4">
    <div class="row">
        <div class="col-12">
            <h2 class="txtContentTitle mb-4"><?= _FORUM_REPLY; ?></h2>
            
            <div class="card">
                <div class="card-body">
                    <p class="mb-4"><?= _FORUM_REPLY_INSTRUCTION; ?></p>
                    ...
                    <div class="mb-4">
                        ...
                        <a href="<?= $_SERVER['PHP_SELF'] ?>?modname=<?= $module_name ?>&mf=viewitem&fid=<?= $_REQUEST['fid']; ?>&fgid=<?= $_REQUEST['fgid']; ?>" class="btn btn-secondary ms-2">
                    ...
                    <form id="postForm" name="post" method="POST" action="<?= $_SERVER['PHP_SELF']; ?>">
                        ...
                        <div class="mb-3">
                            <label for="fitName" class="form-label"><?= _YOUR_NAME; ?></label>
                            <input type="text" name="fitName" id="fitName" class="form-control" placeholder="<?= _YOUR_NAME; ?>" />
                        </div>
                        <?php endif; ?>
                        
                        <div class="mb-3">
                            <label for="fitTitle" class="form-label"><?= _FORUM_SUBJECT; ?></label>
                            <input type="text" name="fitTitle" id="fitTitle" class="form-control" value="RE: <?= htmlspecialchars($rs->fields['fitTitle']); ?>" />
                        </div>
